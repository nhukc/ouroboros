...
def planning_footer() -> str:
    ...
    return """
Distinguish between: game state (scores, history, data), game rules (rules.md, how the game works), and your current decision (what you propose now). These are separate concepts.
...
def voting_footer() -> str:
    ...
    return """
Distinguish between: game state (scores, history, data), game rules (rules.md, how the game works), and your current decision (how you vote now). These are separate concepts.
